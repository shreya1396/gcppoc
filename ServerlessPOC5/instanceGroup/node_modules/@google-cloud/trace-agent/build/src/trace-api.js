    ...
    createChildSpan(options) {
        ...
        if (rootSpan.type === constants_1.SpanType.ROOT) {
            ...
            if (rootSpan.trace.spans.length === this.config.spansPerTraceSoftLimit) {
                ...
                this.logger.error(`TraceApi#createChildSpan: [${this.pluginName}] Adding child span [${options.name}] will cause the trace with root span [${rootSpan.span.name}] to contain more than ${this.config
